      ...
      <div className="diff-view-body">
        {lines.map((line, i) => (
          <div key={i} className="diff-row">
            <span className={`diff-cell diff-cell--old${line.type === 'delete' ? ' diff-cell--del' : line.type === 'insert' ? ' diff-cell--blank' : ''}`}>
              <span className="diff-line-no">{line.oldLineNo ?? ''}</span>
              <span className="diff-line-text">{line.type !== 'insert' ? line.text : ''}</span>
            </span>
            <span className={`diff-cell diff-cell--new${line.type === 'insert' ? ' diff-cell--ins' : line.type === 'delete' ? ' diff-cell--blank' : ''}`}>
