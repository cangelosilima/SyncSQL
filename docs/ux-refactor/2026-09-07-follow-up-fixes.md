...
- Removed redundant shell server badges. Demo SQL_A linked server renamed REMOTE2 in the fixture and references, without executing SQL or renaming the actual remote host/database.
